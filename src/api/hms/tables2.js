...
const data = {
    ...
    praktisi: [
        { id: 1, nama: "Dr. Susilo", spesialisasi: "Dokter Umum", telepon: "08567891234", email: "dr.susilo@rssehat.com", id_organisasi: 1 },
        { id: 2, nama: "Dr. Dewi", spesialisasi: "Dokter Spesialis Penyakit Dalam", telepon: "08123456789", email: "dr.dewi@rssehat.com", id_organisasi: 1 },
    ],
    organisasi: [
    ...
    permintaan_obat: [
        { id: 1, id_pasien: 1, deskripsi: "Resep obat untuk menurunkan tekanan darah." },
        { id: 2, id_pasien: 2, deskripsi: "Resep obat untuk mengatasi serangan asma." },
    ],
    distribusi_obat: [
        { id: 1, id_permintaan_obat: 1, deskripsi: "Pemberian obat Amlodipine 5mg, 1x1." },
        { id: 2, id_permintaan_obat: 2, deskripsi: "Pemberian inhaler Ventolin 2 puff, 3x1." },
    ],
    obat: [
        { id: 1, nama: "Amlodipine", deskripsi: "Obat untuk menurunkan tekanan darah." },
        { id: 2, nama: "Ventolin", deskripsi: "Obat untuk mengatasi serangan asma." },
    ],
    permintaan_layanan: [
        { id: 1, id_pasien: 1, deskripsi: "Pemeriksaan darah rutin." },
        { id: 2, id_pasien: 2, deskripsi: "Pemeriksaan fungsi paru." },
    ],
    klaim: [
